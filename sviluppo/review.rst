...
Le PR pronte per essere verificate sono identificate dall'etichetta **needs review**.
...
Se è necessario apportare delle modifiche o segnalare degli errori, descrivere nel commento in modo dettagliato il comportamento desiderato o i passi da eseguire per riprodurre l’errore. Selezionare quindi l’opzione **Request changes**.
