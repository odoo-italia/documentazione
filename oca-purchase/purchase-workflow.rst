...
:banner: banners/purchase-workflow.jpg
...
.. toctree::
   ...
   purchase-workflow/purchase_order_product_recommendation_secondary_unit
   purchase-workflow/purchase_picking_state
   purchase-workflow/purchase_order_type
   purchase-workflow/purchase_analytic_global
   purchase-workflow/purchase_order_line_price_history
   purchase-workflow/product_form_purchase_link
   ...
   purchase-workflow/purchase_order_line_description
   purchase-workflow/purchase_requisition_tier_validation
   purchase-workflow/purchase_deposit
   purchase-workflow/purchase_date_planned_manual
   purchase-workflow/purchase_triple_discount
   purchase-workflow/purchase_order_line_deep_sort
   ...
   purchase-workflow/purchase_landed_cost
   purchase-workflow/purchase_order_product_recommendation_forecast
   purchase-workflow/purchase_order_general_discount
   purchase-workflow/supplier_calendar
   ...
   purchase-workflow/purchase_stock_return_request
